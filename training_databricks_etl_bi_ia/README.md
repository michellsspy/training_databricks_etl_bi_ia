...
The 'training_databricks_etl_bi_ia' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/training_databricks_etl_bi_ia/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] training_databricks_etl_bi_ia_etl` to your workspace.
